package com.mengc.nettySpring.netty.netty.handler;

import com.mengc.nettySpring.NettySpringApplication;
import com.mengc.nettySpring.netty.netty.busAtomHandler.FileByteServerHandler;
import com.mengc.nettySpring.spring.DispathChannel;
            ...
            while (buffer1.isReadable()) {
                ...
                if("GET".equalsIgnoreCase(f)){//http请求
                    ...
                    if (ctx.pipeline().get("httpDownFileServerHandler") == null) {
                        ...
                        ctx.pipeline().addLast( "dispathChannel", new DispathChannel(NettySpringApplication.dispatcherServlet));
                    }
